...
var statusFromStatusId = {
  error: "ERROR ",
  warn: "WARN ",
  info: "INFO ",
  success: "SUCCESS "
};
var colorFromStatusId = {
  bg: {
    error: "bgRed",
    info: "bgBlue",
    success: "bgGreen",
...
`];
  ...
  const statusMsg = statusFromStatusId[statusId];
  const fgColor = colorFromStatusId.fg[statusId];
  const bgColor = colorFromStatusId.bg[statusId];
  if (includeTimestamp)
